void main() {
  ...
  pessoasSemDuplicado.forEach((pessoas) => print(pessoas[0]));
  ...
  print(
      '3 - Filtrar e deixar a lista somente com pessoas maiores de 18 anos e apresente essas pessoas pelo nome');
  final pessoasMaiores18 = pessoasSemDuplicado.where((pessoas) {
    final idade = int.tryParse(pessoas[1]) ?? 0;
    return idade > 18;
  }).toList();
  pessoasMaiores18.forEach((pessoas) => print(pessoas[0]));
  ...
  //poderia também exibir a mais nova
